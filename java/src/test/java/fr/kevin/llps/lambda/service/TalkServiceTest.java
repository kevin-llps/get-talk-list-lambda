...
class TalkServiceTest {
    ...
    @BeforeEach
    void setUp() {
        talkService = new TalkService(databaseService);
    }
    ...
    void shouldGetTalks() throws JsonProcessingException, SQLException {
        ...
        when(databaseService.openConnection(secretsManagerClient, SECRET_NAME)).thenReturn(connection);
        ...
        List<Talk> talks = talkService.getTalks(secretsManagerClient, SECRET_NAME);
